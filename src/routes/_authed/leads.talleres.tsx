...
/**
 * El embudo del marketplace: usuario → taller. Es la pestaña "Talleres" de
 * `/leads`, y la ÚNICA de las cinco cuyo dato es un `Lead` del backend.
 *
 * ── Qué reemplaza ───────────────────────────────────────────────────────────
 *
 ...
 */
export const Route = createFileRoute('/_authed/leads/talleres')({
  /**
  ...
  head: () => ({ meta: [{ title: 'Leads · Talleres — AutoLibre' }] }),
  component: Leads,
})
