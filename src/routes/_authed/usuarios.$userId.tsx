...
function UserDetailScreen() {
  ...
  return (
    <>
      ...
      <div className="mt-4">
        <MaintenanceTasks tasks={user.tasks} />
      </div>
    </>
  )
}
...
// `Tasks`/`TaskRow`/`TaskStateTag` se mudaron a `~/components/MaintenanceTasks`
// el 2026-09-25, para que `/leads/pedidos/:id` las reuse con las tareas de UN
// vehículo en vez de las de TODOS los del usuario.
