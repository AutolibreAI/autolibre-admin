...
| `ops-write-actions.md` | Los SP de `ops` que escriben `public`: por qué se permiten, los 8 guardrails, las dos minas, los dos SP que se decidió NO escribir, y la 011 (pedidos de presupuesto: la auditoría sin la ubicación exacta y los parámetros `text` porque la tabla no existe en producción) |
